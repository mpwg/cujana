...
nonisolated public struct OpenMeteoWeatherDailyDTO: Codable, Equatable, Sendable {
...
nonisolated public struct OpenMeteoWeatherResponseDTO: Codable, Equatable, Sendable {
    ...
    public let daily: OpenMeteoWeatherDailyDTO

    public init(latitude: Double, longitude: Double, daily: OpenMeteoWeatherDailyDTO) {
