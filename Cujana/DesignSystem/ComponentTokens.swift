...
enum HomeOverviewToken {
    ...
    static let navigationLogoHeight: CGFloat = 38
    static let navigationLogoOpacity = 0.92
    ...
    static let dayCardWidth: CGFloat = 158
    static let dayCardHeight: CGFloat = 138
    static let dayCardCornerRadius: CGFloat = 28
    static let dayLabelTracking = 1.6
    static let dayWeatherIconSize: CGFloat = 44
    static let dayWeatherIconSmallSize: CGFloat = 30
    static let dayWeatherIconFontSize: CGFloat = 16
    static let dayWeatherIconOpacity = 0.65
    ...
    static let weatherContextOpacity = 0.72
    ...
    static let ctaHeight: CGFloat = 158
...
enum ForecastDetailToken {
    ...
    static let dayPickerMinHeight: CGFloat = 46
    static let dayPickerHeight: CGFloat = 54
    static let dayPickerSurfaceOpacity = 0.75
    static let dayPickerPadding: CGFloat = 4
    static let dayPickerCornerRadius: CGFloat = 27
    static let weatherIconSize: CGFloat = 52
    static let weatherMinHeight: CGFloat = 118
    static let weatherCardPadding: CGFloat = 16
    static let weatherCardCornerRadius: CGFloat = 30
    static let allergenIconSize: CGFloat = 30
    static let allergenIconFrameSize: CGFloat = 50
    static let allergenRowMinHeight: CGFloat = 96
    ...
    static let hourlyChipWidth: CGFloat = 62
    static let hourlyCurrentChipWidth: CGFloat = 78
    ...
    static let hourlyWeatherTextOpacity = 0.72
    ...
    static let allergyWeatherContextOpacity = 0.74
...
enum SymptomCheckInToken {
    ...
    static let introMaxWidth: CGFloat = 300
    static let fieldContainerPadding: CGFloat = 16
    static let symptomPillMinHeight: CGFloat = 50
    static let symptomPillPaddingH: CGFloat = 18
    static let symptomBorderOpacity = 0.18
    static let symptomSelectedBackground = Color(hex: "#E5EFE7")
    static let symptomIconOpacity = 0.92
    static let symptomIconSize: CGFloat = 20
    static let severityPillMinHeight: CGFloat = 48
