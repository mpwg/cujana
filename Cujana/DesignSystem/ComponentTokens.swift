...
enum SymptomCheckInToken {
    ...
    static let symptomGridMinimumWidth: CGFloat = 184
    ...
    static let symptomPillMinHeight: CGFloat = 82
    ...
    static let severityPillMinHeight: CGFloat = 42
    static let severityPillMinWidth: CGFloat = 116
    static let severityPillSpacing: CGFloat = 10
    static let severityPillPaddingH: CGFloat = 18
    static let severityPillCornerRadius: CGFloat = 21
    static let severityTextMinimumScale = 0.8
    static let severityUnselectedText = Color(hex: "#474747")
    static let severityUnselectedBackground = Color.clear
