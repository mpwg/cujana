...
enum SymptomCheckInToken {
    ...
    static let sectionDescriptionOpacity = 0.86
    ...
    static let symptomSelectedText = Color(hex: "#587562")
    static let symptomIconOpacity = 0.65
    ...
    static let severityUnselectedBackground = Color(hex: "#3C3C43").opacity(0.06)
    ...
    static let saveButtonPressedBackground = Color(hex: "#5E7D66")
    ...
    static let navigationInfoOpacity = 0.64
