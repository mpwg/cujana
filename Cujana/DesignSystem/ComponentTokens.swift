...
enum SymptomCheckInToken {
    ...
    static let selectedIcon = Color(hex: "#5C7A63")
    static let selectedText = Color(hex: "#2F4B36")
    static let groupedBackground = Color(hex: "#F1EEE8")
    ...
    static let symptomPillPaddingV: CGFloat = 12
    static let symptomPillSpacing: CGFloat = 12
    static let symptomTextMinimumScale = 0.9
    static let symptomSelectedBackground = Color(hex: "#DDEADF")
    static let symptomUnselectedBorder = Color(hex: "#3C3C43").opacity(0.1)
    static let symptomUnselectedIconOpacity = 0.85
    static let symptomSelectedBorderWidth: CGFloat = 1.5
    static let symptomUnselectedBorderWidth: CGFloat = 1
    static let symptomIconSize: CGFloat = 19
    static let symptomCheckmarkSize: CGFloat = 18
    static let symptomSelectedScale = 0.99
    static let symptomPillCornerRadius: CGFloat = 20
    ...
    static let severityPillMinWidth: CGFloat = 86
    static let severityTextMinimumScale = 0.8
    static let severityUnselectedText = Color(hex: "#474747")
    static let severityUnselectedBackground = Color(hex: "#ECE7DF")
    static let severitySelectedScale = 1.02
    ...
    static let dateCardCollapsedHeight: CGFloat = 88
    ...
    static let saveButtonShadow = ShadowTokenValue(color: Color(hex: "#6D8F76").opacity(0.22), radius: 24, y: 8)
    static let navigationButtonSize: CGFloat = 44
    static let disabledTextOpacity = 0.8
    static let disabledButtonOpacity = 1.0
    static let animationDuration = 0.24
    static let reducedMotionAnimationDuration = 0.01
