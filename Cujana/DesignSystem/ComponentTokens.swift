...
enum ForecastDetailToken {
    ...
    static let contextSpacing: CGFloat = 14
    static let cardHorizontalPadding: CGFloat = 20
    static let compactCardVerticalPadding: CGFloat = 12
    static let bottomInsetHeight: CGFloat = 34
    static let navigationButtonSize: CGFloat = 48
    static let dayPickerMinHeight: CGFloat = 40
    ...
    static let hourlyCurrentDotSize: CGFloat = 7
    static let hourlyChipWidth: CGFloat = 52
    static let hourlyCurrentChipWidth: CGFloat = 58
    static let hourlyChipMinHeight: CGFloat = 78
    static let hourlyCurrentChipMinHeight: CGFloat = 84
    ...
    static let noRiskSheetHeight: CGFloat = 300
}
